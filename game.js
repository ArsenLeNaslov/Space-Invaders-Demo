...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var music = play("Retro_Platforming-David_Fesliyan", { loop: true, volume: 1 });
  var ALIEN_ROWS = 5;
  var ALIEN_COLS = 6;
  var ALIEN_SPEED = 15;
  var ALIEN_STEPS = 322;
  var ALIEN_ROWS_MOVE = 7;
  var BLOCK_HEIGHT = 40;
  var BLOCK_WIDTH = 32;
  var OFFSET_X = 208;
  var OFFSET_Y = 100;
  var PLAYER_MOVE_SPEED = 500;
  var SCREEN_EDGE = 100;
  var GUN_COOLDOWN_TIME = 0.2;
  var BULLET_SPEED = 500;
  var POINTS_PER_ALIEN = 100;
  loadRoot("sprites/");
  ...
  scene("game", () => {
    ...
    __name(spawnAliens, "spawnAliens");
    spawnAliens();
    ...
    __name(moveAliensDown, "moveAliensDown");
    ...
    onCollide("bullet", "alien", (bullet, alien) => {
      ...
      alienMap[alien.row][alien.col] = null;
    ...
    __name(updateLives, "updateLives");
  });
